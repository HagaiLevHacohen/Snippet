export default function NewSnippetDialog({ onClose }) {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      {/* Dialog card */}
      <div className="relative bg-gray-800 rounded-xl shadow-2xl w-96 max-w-[90%] p-6 flex flex-col animate-fade-in z-50">
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <button className="px-4 py-2 bg-violet-500 rounded-lg hover:bg-violet-600 text-white">
            Post
          </button>
        </div>
      </div>
